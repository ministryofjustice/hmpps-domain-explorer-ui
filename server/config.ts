...
export default {
  ...
  apis: {
    ...
    exampleApi: {
      url: get('DOMAIN_EXPLORER_API_URL', 'http://localhost:8080', requiredInProduction),
      healthPath: '/health/ping',
      timeout: {
        response: Number(get('DOMAIN_EXPLORER_API_TIMEOUT_RESPONSE', 5000)),
        deadline: Number(get('DOMAIN_EXPLORER_API_TIMEOUT_DEADLINE', 5000)),
      },
      agent: new AgentConfig(Number(get('DOMAIN_EXPLORER_API_TIMEOUT_RESPONSE', 5000))),
    },
  },
  sqs: {
    audit: auditConfig(),
